...
public class Generador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        aleatorio = new javax.swing.JTextField();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(aleatorio, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(28, 28, 28)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int aleatorio=Integer.parseInt(this.aleatorio.getText().trim());
        
        CsAleatorio a = new CsAleatorio();
        
        ArrayList<Fila> e= a.aleatorio(aleatorio);
        Modelo m = new Modelo(e);
        
        this.jTable1.setModel(m);    
        }catch(Exception e){
            JOptionPane.showMessageDialog(null," Dato Capturado");
        }
    ...
    private javax.swing.JTextField aleatorio;
